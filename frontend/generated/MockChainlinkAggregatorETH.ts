...
export interface MockChainlinkAggregatorETHInterface extends utils.Interface {
  functions: {
...
export interface MockChainlinkAggregatorETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockChainlinkAggregatorETHInterface;
