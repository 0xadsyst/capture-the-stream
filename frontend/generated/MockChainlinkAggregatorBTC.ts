...
export interface MockChainlinkAggregatorBTCInterface extends utils.Interface {
  functions: {
...
export interface MockChainlinkAggregatorBTC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockChainlinkAggregatorBTCInterface;
