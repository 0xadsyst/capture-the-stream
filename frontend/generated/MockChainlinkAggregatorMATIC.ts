...
export interface MockChainlinkAggregatorMATICInterface extends utils.Interface {
  functions: {
...
export interface MockChainlinkAggregatorMATIC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockChainlinkAggregatorMATICInterface;
